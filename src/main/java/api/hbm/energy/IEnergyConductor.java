...
public interface IEnergyConductor extends IEnergyConnector {
    ...
    public default int getIdentity() {
        return getIdentityFromTile((BlockEntity) this);
    }

    public static int getIdentityFromTile(BlockEntity te) {
        return getIdentityFromPos(te.getBlockPos());
    }
    ...
    public default List<BlockPos> getConnectionPoints() {
        ...
        for (ForgeDirection dir : ForgeDirection.VALID_DIRECTIONS) {
            pos.add(tile.getBlockPos().offset(dir.offsetX, dir.offsetY, dir.offsetZ));
        }
    ...
    public default long transferPower(long power) {
        ...
        if (this.getPowerNet() == null) return power;
