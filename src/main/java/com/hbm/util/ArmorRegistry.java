...
public class ArmorRegistry {
	...
	public static boolean hasAllProtection(Entity entity, EquipmentSlot slot, HazardClass... clazz) {
//
...
//		return list.containsAll(Arrays.asList(clazz));
	...
	public static boolean hasAnyProtection(Entity entity, EquipmentSlot slot, HazardClass... clazz) {
...
//		}
	...
	public static boolean hasProtection(Entity entity, EquipmentSlot slot, HazardClass clazz) {
