...
public class RecipesCommon {
        ...
        public boolean isApplicable(ComparableStack comp) {
            ...
            if (this instanceof OreDictStack) {
                ...
                for (ItemStack stack : ores) {
                    if (stack.getItem().equals(comp.item) && stack.getDamageValue() == comp.meta)
                        return true;
                }
            }
    ...
    public static class ComparableStack extends AStack {
        ...
        public boolean matchesRecipe(ItemStack stack, boolean ignoreSize) {
            ...
            if (this.meta != OreDictionary.WILDCARD_VALUE && stack.getDamageValue() != this.meta)
                return false;
    ...
    public static class NbtComparableStack extends ComparableStack {
        ...
        public boolean equals(Object obj) {
            if (!stack.hasTag() || !(obj instanceof NbtComparableStack)) {
                ...
                return super.equals(obj) && Library.tagContainsOther(stack.getTag(),
                        ((NbtComparableStack) obj).stack.getTag());
            }
        }

        @Override
        public boolean matchesRecipe(ItemStack stack, boolean ignoreSize) {
            return super.matchesRecipe(stack, ignoreSize) && Library.tagContainsOther(this.stack.getTag(),
                    stack.getTag());
        }
