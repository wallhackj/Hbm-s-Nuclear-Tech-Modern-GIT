...
public class RBMKDials {
    ...
    public static void createDials(Level world) {
    ...
    public static double getColumnHeatFlow(Level world) {
        return clamp(shittyWorkaroundParseDouble(world.getGameRules().getString(KEY_COLUMN_HEAT_FLOW), 5.0D), 0.0D, 1.0D);
    }
    ...
    public static double getFuelHeatProvision(Level world) {
        return clamp(shittyWorkaroundParseDouble(world.getGameRules().getString(KEY_HEAT_PROVISION), 0.2D), 0.0D, 1.0D);
    }
    ...
    public static int getColumnHeight(Level world) {
        return clamp(shittyWorkaroundParseInt(world.getGameRules().getString(KEY_COLUMN_HEIGHT), 4), 1, 250) - 1;
    }
    ...
    public static int getFluxRange(Level world) {
        return clamp(shittyWorkaroundParseInt(world.getGameRules().getString(KEY_FLUX_RANGE), 5), 1, 100);
    }
    ...
    public static int getReaSimRange(Level world) {
        return clamp(shittyWorkaroundParseInt(world.getGameRules().getString(KEY_REASIM_RANGE), 10), 1, 100);
    }
    ...
    public static int getReaSimCount(Level world) {
        return clamp(shittyWorkaroundParseInt(world.getGameRules().getString(KEY_REASIM_COUNT), 6), 1, 24);
    }
    ...
    public static double getReaSimBoilerSpeed(Level world) {
        return clamp(shittyWorkaroundParseDouble(world.getGameRules().getString(KEY_REASIM_BOILER_SPEED), 0.05D), 0.0D, 1.0D);
    }
