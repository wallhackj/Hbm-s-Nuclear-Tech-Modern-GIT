...
public class ModItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, RefStrings.MODID);
    ...
    private static RegistryObject<Item> createItem(String itemName, Item item) {
        RegistryObject<Item> itemObj = ITEMS.register(itemName, () -> item);
        itemMap.put(itemName, itemObj);
        return itemObj;
    }



    public static final Item redstone_sword = createItem("redstone_sword", new RedstoneSword());
            new RedstoneSword(ToolMaterial.STONE, "redstone_sword").setCreativeTab(CreativeTabs.COMBAT);
    ...
    //Tools
    public static final Item screwdriver = new Item(ToolType.SCREWDRIVER, 100, "screwdriver");
    public static final Item screwdriver_desh = new Item(ToolType.SCREWDRIVER, -1, "screwdriver_desh");
    public static final Item hand_drill = new Item(ToolType.HAND_DRILL, 100, "hand_drill");
