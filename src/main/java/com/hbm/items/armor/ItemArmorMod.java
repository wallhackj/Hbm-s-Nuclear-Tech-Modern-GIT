...
public class ItemArmorMod extends ItemCustomLore {
    ...
    @Override
    public void addInformation(ItemStack stack, Level worldIn, List<String> list, ITooltipFlag flagIn) {
        ...
        switch (this.type) {
            case ArmorModHandler.helmet_only:
                list.add("  " + I18nUtil.resolveKey("desc.applicableh1"));
                break;
            case ArmorModHandler.plate_only:
                list.add("  " + I18nUtil.resolveKey("desc.applicablec1"));
                break;
            case ArmorModHandler.legs_only:
                list.add("  " + I18nUtil.resolveKey("desc.applicablel1"));
                break;
            case ArmorModHandler.boots_only:
                list.add("  " + I18nUtil.resolveKey("desc.applicableb1"));
                break;
            case ArmorModHandler.servos:
                list.add("  " + I18nUtil.resolveKey("desc.applicableservo"));
                break;
            case ArmorModHandler.cladding:
                list.add("  " + I18nUtil.resolveKey("desc.applicablecladding"));
                break;
            case ArmorModHandler.kevlar:
                list.add("  " + I18nUtil.resolveKey("desc.applicableinsert"));
                break;
            case ArmorModHandler.extra:
                list.add("  " + I18nUtil.resolveKey("desc.applicableextra"));
                break;
        }
    }
