...
//
//public class TestRender extends Block implements BlockEntityProvider {
//
//	// Y U NO WANTED WORKINGS? NAO U WORKINGS AN I KICK UR ARSE
//
//	//Drillgon200: 0.0625 is one pixel in world space; 1/16.
//	public static final AABB TEST_RENDER_BB = new AABB(2 * 0.0625F, 0.0F, 2 * 0.0625F, 14 * 0.0625F, 1.0F, 14 * 0.0625F);
//
...
//	@Override
//	public TileEntity createNewTileEntity(Level var1, int var2) {
