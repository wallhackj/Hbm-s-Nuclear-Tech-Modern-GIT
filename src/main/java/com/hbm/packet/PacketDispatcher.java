...
public class PacketDispatcher {
    ...
    public static final void registerPackets() {
        ...
        //PressPacket
//		wrapper.registerMessage(i++, TEPressPacket.class, TEPressPacket::encode,TEPressPacket::decode,
//				TEPressPacket.Handler.class , Optional.of(NetworkDirection.PLAY_TO_CLIENT));

        wrapper.registerMessage(i++, TEPressPacket.class, TEPressPacket::encode, TEPressPacket::decode, TEPressPacket.Handler::handle, NetworkEvent.Context::enqueueWork, Dist.CLIENT);

        //Send chunk radiation packet to individual players
        wrapper.registerMessage(SurveyPacket.Handler.class, SurveyPacket.class, i++, MixinEnvironment.Side.CLIENT);
...
//		wrapper.registerMessage(ControlPanelLinkerClientPacket.Handler.class, ControlPanelUpdatePacket.class, i++, Side.CLIENT);
    ...
    private static <T> void registerPacket(Class<? extends PacketHandler<T>> handlerClass, Class<T> packetClass,
                                           int id, Dist side) {
        wrapper.registerMessage(id, packetClass, PacketHandler::encode, PacketHandler::decode, handlerClass, side);
    }
